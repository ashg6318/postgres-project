...
def process_song_file(cur, filepath):
    """
    - Pulls song and artist information from from 1 file from data/song_data
...
def process_log_file(cur, filepath):
    """
    - Pulls user, activity and time information from 1 file from data/log_data
    - Inserts data into songplays, users and time tables
    """
    # open log file
    df = pd.read_json(filepath, lines=True)
